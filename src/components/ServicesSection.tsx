...
const SERVICES = [
  ...
  },
  {
    ...
    description:
      'Designing and building scalable server-side architectures, robust RESTful APIs, and database models with Python and SQL — ensuring high performance, security, and smooth frontend integrations.',
  },
  {
    number: '03',
    title: 'ML and GenAI Integration',
    description:
      'Building predictive machine learning models and wiring large language models into real products via Scikit-learn, Gemini, Claude, and OpenAI APIs — from data-driven systems to AI agents.',
  },
  {
    number: '04',
