...
const ABOUT_PARAGRAPHS = [
  "I’m Anshul Soni, a B.Tech student in Artificial Intelligence & Data Science at SISTec, passionate about building innovative digital experiences that combine creativity, technology, and automation. I specialize in UI/UX design, front-end development, AI-powered applications, and GenAI integrations — transforming ideas into smart, engaging, and user-focused solutions.",
  "From developing automation workflows and AI-integrated systems to exploring modern web technologies and content-driven experiences, I enjoy creating projects that are both functional and impactful. Alongside tech, I’m also growing my entrepreneurial mindset through my brands and creative ventures.",
  "I believe in continuous learning, experimenting with new technologies, and building products that solve real-world problems while delivering great user experiences. Let’s build something incredible together!"
];
      ...
      <div className="relative z-10 flex flex-col items-center gap-10 sm:gap-14 md:gap-16 text-center">
        <FadeIn delay={0} y={40}>
          ...
          <div className="flex flex-col items-center gap-12 sm:gap-16 md:gap-20">
                    <div className="flex flex-col gap-6 max-w-[600px] text-center items-center">
                      {ABOUT_PARAGRAPHS.map((para, idx) => (
                        <AnimatedText
                          key={idx}
                          text={para}
                          className="font-medium leading-relaxed text-[#D7E2EA]/90"
