...
const CONTACT_METHODS: ContactMethod[] = [
  {
    icon: Mail,
    label: 'Email',
    value: 'anshulsoni3019@gmail.com',
    href: 'mailto:anshulsoni3019@gmail.com',
  },
  {
    icon: MessageCircle,
    label: 'WhatsApp',
    value: '+91 93439 77234',
    // wa.me requires digits only — no +, no spaces, no hyphens
    href: 'https://wa.me/919343977234',
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    value: 'in/anshul-soni-b838a3339',
    href: 'https://www.linkedin.com/in/anshul-soni-b838a3339/',
  },
  {
    icon: Github,
    label: 'GitHub',
    value: '@bankai1903',
    href: 'https://github.com/bankai1903',
  },
];
